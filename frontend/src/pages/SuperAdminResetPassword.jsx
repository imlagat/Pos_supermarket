      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center">
          <div className="text-center md:text-left mb-10">
            ...
            <p className="text-gray-500 mt-2 font-medium">Please enter your new super admin password below</p>
          </div>
          ...
          <div className="w-full max-w-sm mx-auto md:mx-0 mt-8 text-center">
            <Link to="/super-admin/login" className="text-orange-600 hover:text-orange-800 font-bold underline transition-colors">
              Back to Login
            </Link>
          </div>
        </div>
